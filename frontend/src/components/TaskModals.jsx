...
export function ConfirmDeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="glass-card p-4.5 rounded-xl border border-slate-700/60 w-full max-w-xs space-y-3 shadow-2xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 text-amber-400">
            <Trash2 className="w-4 h-4" />
            <h3 className="text-xs font-bold text-white">Archive Task?</h3>
          </div>
        ...
        <p className="text-[11px] text-slate-300 line-clamp-2 bg-slate-900/80 p-2.5 rounded-lg border border-slate-800 font-medium">
          "{task.title}"
        </p>

        <p className="text-[10px] text-slate-400">
          Task will be moved to Archive and can be restored anytime from Audit Logs.
        </p>
        ...
        <div className="flex items-center justify-end space-x-2 pt-1">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-gradient-to-r from-amber-400 via-amber-500 to-yellow-600 hover:brightness-110 text-slate-950 font-bold text-[11px] rounded-lg shadow-md shadow-amber-500/20 flex items-center space-x-1 transition"
          >
            <span>Archive</span>
          </button>
        </div>
